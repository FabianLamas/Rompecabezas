...
function definirGrillaGanadora(){
  grillaGanadora = grilla;
}

function chequearSiGano() {
    for (var i = 0; i < grilla.length; i++) {
      for (var e = 0; e < grilla.length; e++) {
          if(grilla[i][e] != grillaGanadora[i][e]){
              return false;
          }
      }
    }
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
    var filaTemp = filaPos1;
    var colTemp = columnaPos1;
